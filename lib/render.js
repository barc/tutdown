 ...
 */
(function() {
  var async, beautifyCss, beautifyHtml, beautifyJs, codeFilter, fs, marked, parse, renderAssets, renderMarkup, str, utils, _;
  ...
  renderAssets = function(id, assets, layout, iframeAttributes, cb) {
    var assetId, assetsTemplate, codeTemplate, idOrig, linkFirstTemplate, linkTemplate, processAsset, tabDivs, tabLinks, tabTemplate;
    idOrig = id;
    id = id.toLowerCase();
    assetId = 0;
    tabLinks = "";
