...
renderAssets = function(id, assets, options, cb) {
  var assetId, assetsTemplate, codeTemplate, idOrig, iframeAttributes, layout, linkFirstTemplate, linkTemplate, outDirname, processAsset, tabDivs, tabLinks, tabTemplate;
