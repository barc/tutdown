 ...
 */
(function() {
  var Funcd, coffee, createContent, createNav, dox, fixCoffeeComments, fs, getCaption, getMethodParams, getSections, isClass, isInstanceMethod, isInstanceProperty, isStaticMethod, isTopLevelFunction, _;
  ...
  createNav = function(t, data) {
    ...
    for (_i = 0, _len = sections.length; _i < _len; _i++) {
      ...
      _results.push(t.ul({
        ...
        var isClassMethod, item, itemName, _j, _len1, _ref, _results1;
        _ref = section.slice(1);
        _results1 = [];
        for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
          item = _ref[_j];
          if (item.ctx) {
            isClassMethod = item.ctx.string.indexOf('.prototype.') < 0 && item.ctx.string.indexOf('this.') < 0;
  ...
  createContent = function(t, data) {
    ...
    for (_i = 0, _len = sections.length; _i < _len; _i++) {
      ...
      _results.push(t.section(function() {
        var attrs, headerItem, headerItemName, isClassMethod, item, itemName, _j, _len1, _ref, _results1;
        headerItem = _.first(section);
        headerItemName = headerItem.ctx.name;
        t.h2({
          id: "" + headerItemName
