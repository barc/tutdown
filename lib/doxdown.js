 ...
 */
(function() {
  var Funcd, codeFilter, coffee, createContent, createNav, dox, fixCoffeeComments, formatBody, fs, getCaption, getMethodParams, getSections, isClass, isInstanceMethod, isInstanceProperty, isStatic, isStaticMethod, isTopLevelFunction, utils, _;
  ...
  createContent = function(t, data) {
    ...
    for (_i = 0, _len = sections.length; _i < _len; _i++) {
      section = sections[_i];
      t.section(function() {
        var attrs, body, headerItem, headerItemName, isClassMethod, item, itemName, _j, _len1, _ref, _results;
        headerItem = _.first(section);
        headerItemName = headerItem.ctx.name;
        t.h2({
          id: "" + headerItemName
